...
namespace FitnessApp.Web.Data.Migrations
{
    ...
    [Migration("20230701061021_AddingColCreationDateToDiet")]
    partial class AddingColCreationDateToDiet
    {
            ...
            modelBuilder.Entity("Diet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DietId = 1,
                            CaloriesIntake = 2000,
                            CreationDate = new DateTime(2023, 7, 1, 9, 10, 21, 546, DateTimeKind.Local).AddTicks(7827),
                        ...
                        new
                        {
                            DietId = 2,
                            CaloriesIntake = 1800,
                            CreationDate = new DateTime(2023, 7, 1, 9, 10, 21, 546, DateTimeKind.Local).AddTicks(7857),
                            Description = "This is a sample diet plan.",
                            ImageUrl = "https://www.shutterstock.com/image-photo/balanced-diet-healthy-food-on-260nw-590825882.jpg",
                            Name = "Sample Diet 2"
                        },
                        new
                        {
                            DietId = 3,
                            CaloriesIntake = 1800,
                            CreationDate = new DateTime(2023, 7, 1, 9, 10, 21, 546, DateTimeKind.Local).AddTicks(7859),
                            Description = "This is a sample diet plan.",
                            ImageUrl = "https://www.shutterstock.com/image-photo/balanced-diet-healthy-food-on-260nw-590825882.jpg",
                            Name = "Sample Diet 3"
                        },
                        new
                        {
                            DietId = 4,
                            CaloriesIntake = 1800,
                            CreationDate = new DateTime(2023, 7, 1, 9, 10, 21, 546, DateTimeKind.Local).AddTicks(7861),
                            Description = "This is a sample diet plan.",
                            ImageUrl = "https://www.shutterstock.com/image-photo/balanced-diet-healthy-food-on-260nw-590825882.jpg",
                            Name = "Sample Diet 4"
                        });
